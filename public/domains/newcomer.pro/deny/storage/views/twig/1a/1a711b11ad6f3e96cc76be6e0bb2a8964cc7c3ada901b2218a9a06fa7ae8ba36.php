...
/* layouts.homepage */
class __TwigTemplate_f34171f577f7076b9c8b4b68dbb57347789ef6dec72a66de68727dc61250a272 extends TwigBridge\Twig\Template
{
...
\t\t\t\t\t<a href=\"#\" class=\"question__btn btn-main btn btn-reset\">Калькулятор услуг</a>
\t\t\t\t</div>
\t\t\t</div>
\t\t</div>
\t</section>
...
\t\t\t\t\t<img class=\"about__img\" src=\"/site/theme/images/about_img1.png\" alt=\"\">
\t\t\t\t</div>
...
";
        // line 519
        $this->loadTemplate("footer", "layouts.homepage", 519)->display($context);
    }
    ...
    {
        return array (  564 => 519,  45 => 2,  43 => 1,);
    }
}
/* {% include 'header' %}*/
/* */
