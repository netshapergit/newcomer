...
/* layouts.lk_tests */
class __TwigTemplate_545d6e411833083ed7c9365a1609a5273c9dff427e385a80897e19286b68c7f0 extends TwigBridge\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 1
        $this->loadTemplate("header_lk", "layouts.lk_tests", 1)->display($context);
        // line 2
        echo "
...
\t\t\t";
        // line 6
        $this->loadTemplate("menu_lk", "layouts.lk_tests", 6)->display(array_merge($context, array("rolename" => $this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "role", array()), "name", array()))));
        // line 7
        echo "\t\t</div>
...
\t\t\t\t";
        ...
        // line 43
        echo "\t\t\t\t<div class=\"lk-list-item\" v-for=\"item in filteredTests\" :key=\"item.id\">
\t\t\t\t\t";
        // line 44
        if (($this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "role", array()), "name", array()) != "student")) {
            // line 45
...
\t\t\t\t\t\t\t\t\t<h2 class=\"form__title title-medium\">Новый тест</h2>
\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t<input class=\"form-control field--under hidden\" name=\"user_id\" style=\"display:none;\" placeholder=\"Пользователь\" type=\"text\" value=\"";
            ...
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()), "html", null, true));
            echo "\">
\t\t\t\t\t\t\t\t\t<input class=\"form-control field--border hidden\" name=\"layout_id\" style=\"display:none;\" placeholder=\"Макет\" type=\"text\" value=\"27\">
...
";
        // line 138
        $this->loadTemplate("footer_lk", "layouts.lk_tests", 138)->display($context);
        // line 139
        echo "<script src=\"/site/theme/js/lk_tests.js\" type=\"module\"></script>";
    }

    public function getTemplateName()
    {
        return "layouts.lk_tests";
    }
    ...
    {
        return array (  192 => 139,  190 => 138,  184 => 134,  182 => 116,  173 => 109,  168 => 105,  161 => 100,  156 => 98,  133 => 77,  131 => 76,  126 => 73,  117 => 58,  102 => 45,  100 => 44,  97 => 43,  91 => 39,  89 => 38,  56 => 7,  54 => 6,  48 => 3,  45 => 2,  43 => 1,);
    }
}
/* {% include 'header_lk' %}*/
/* */
...
/* 				</div>*/
/* 				{% endif %}*/
/* 				<div class="lk-list-item" v-for="item in filteredTests" :key="item.id">*/
/* 					{% if user.role.name != 'student' %}*/
...
/* 				<input class="form-control field--border" name="layout_id" style="display:none;" placeholder="Макет" type="text" value="27">*/
...
/* */
/* {% include 'footer_lk' %}*/
/* <script src="/site/theme/js/lk_tests.js" type="module"></script>*/
