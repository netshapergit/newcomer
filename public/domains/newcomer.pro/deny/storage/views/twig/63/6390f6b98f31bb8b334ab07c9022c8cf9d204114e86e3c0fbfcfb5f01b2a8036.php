...
class __TwigTemplate_fa7e8cc5fa828a7d1a60956efad42ee9fde29e84dafebfe3a5363a0d87e88920 extends TwigBridge\Twig\Template
{
...
\t\t\t\t";
        ...
        if (($this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "role", array()), "name", array()) != "student")) {
            // line 62
            echo "\t\t\t\t<div class=\"hw-filter\">
\t\t\t\t\t<div class=\"hw-filter__title\">Студенты {{filters.students}}</div>
\t\t\t\t\t<select-filter
\t\t\t\t\t\t:items=\"students\"
