...
/* _.user.pages.list */
class __TwigTemplate_97f9d69ce79529a77fcfc31410accc51c4a7dc69ebf94e10d312e6292e57fafe extends TwigBridge\Twig\Template
{
    public function __construct(Twig_Environment $env)
    {
        ...
        // line 1
        $this->parent = $this->loadTemplate("_.user.base", "_.user.pages.list", 1);
        $this->blocks = array(
...
\t\taction=\"";
        // line 6
        echo $this->env->getExtension('sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute((isset($context["url"]) ? $context["url"] : null), "user", array()), "html", null, true));
        echo "/";
