...
/* layouts.lk_lessons */
class __TwigTemplate_bd3531f2df4264b4c090a32f635eff689afa87a38392a54c6b347042cf7fd99e extends TwigBridge\Twig\Template
{
    ...
    protected function doDisplay(array $context, array $blocks = array())
    {
        ...
        // line 1
        $this->loadTemplate("header_lk", "layouts.lk_lessons", 1)->display($context);
        // line 2
        echo "
...
\t\t\t";
        // line 6
        $this->loadTemplate("menu_lk", "layouts.lk_lessons", 6)->display(array_merge($context, array("rolename" => $this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "role", array()), "name", array()))));
        // line 7
        echo "\t\t</div>
...
\t\t\t\t";
        ...
        if (($this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "role", array()), "name", array()) != "student")) {
            // line 39
            echo "\t\t\t\t<div class=\"lk-list-item lk-list-item--new\" @click.stop=\"isNewEntityCreateModalShowed = true\">
\t\t\t\t\tДобавить урок
\t\t\t\t</div>
\t\t\t\t";
        }
        // line 43
        echo "\t\t\t\t<div class=\"lk-list-item\" v-for=\"item in filteredLessons\" :key=\"item.id\">
\t\t\t\t\t";
        // line 44
        if (($this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "role", array()), "name", array()) != "student")) {
            // line 45
...
\t\t\t\t\t";
        ...
        // line 58
        echo "\t\t\t\t\t<div class=\"lk-list-item__block\">
...
\t\t\t";
        ...
        if (($this->getAttribute($this->getAttribute((isset($context["user"]) ? $context["user"] : null), "role", array()), "name", array()) != "student")) {
            // line 77
            echo "\t\t\t<div class=\"modal modal--vue\" v-show=\"isNewEntityCreateModalShowed\" v-cloak>
\t\t\t\t<div class=\"cont\">
...
\t\t\t\t\t\t\t\t\t<h2 class=\"form__title title-medium\">Новый урок</h2>
\t\t\t\t\t\t\t\t\t
...
\t\t\t\t\t\t\t\t\t\t\t\t<select name=\"field_programs_courses[] hidden\" multiple v-model=\"newObject.lesson_courses\">
...
\t\t\t\t\t\t\t\t\t<input class=\"form-control field--under hidden\" name=\"user_id\" style=\"display:none;\" placeholder=\"Пользователь\" type=\"text\" value=\"";
            ...
            echo $this->env->getExtension('sandbox')->ensureToStringAllowed(twig_escape_filter($this->env, $this->getAttribute((isset($context["user"]) ? $context["user"] : null), "id", array()), "html", null, true));
            echo "\">
\t\t\t\t\t\t\t\t\t<input class=\"form-control field--border hidden\" name=\"layout_id\" style=\"display:none;\" placeholder=\"Макет\" type=\"text\" value=\"22\">
...
\t\t\t\t\t\t\t\t\t
\t\t\t\t\t\t\t\t\t<select name=\"field_courses_lessons[]\" class=\"hidden\" multiple v-model=\"newObject.lesson_courses\">
\t\t\t\t\t\t\t\t\t\t<option v-for=\"course in courses\" :value=\"course.id\">{{course.field_header}}</option>
\t\t\t\t\t\t\t\t\t</select>
\t\t\t\t\t\t\t\t\t";
            // line 119
...
";
        // line 151
        $this->loadTemplate("footer_lk", "layouts.lk_lessons", 151)->display($context);
        // line 152
        echo "<script src=\"/site/theme/js/lk_lessons.js\" type=\"module\"></script>";
    }

    public function getTemplateName()
    {
        return "layouts.lk_lessons";
    }
    ...
    {
        return array (  202 => 152,  200 => 151,  194 => 147,  192 => 126,  183 => 119,  176 => 113,  169 => 108,  164 => 106,  133 => 77,  131 => 76,  126 => 73,  117 => 58,  102 => 45,  100 => 44,  97 => 43,  91 => 39,  89 => 38,  56 => 7,  54 => 6,  48 => 3,  45 => 2,  43 => 1,);
    }
}
/* {% include 'header_lk' %}*/
/* */
...
/* 				</div>*/
/* 				{% endif %}*/
/* 				<div class="lk-list-item" v-for="item in filteredLessons" :key="item.id">*/
/* 					{% if user.role.name != 'student' %}*/
...
/* 				<input class="form-control field--border" name="layout_id" style="display:none;" placeholder="Макет" type="text" value="22">*/
...
/* */
/* 				<input class="form-control field--under" name="alias" placeholder="Алиас" type="text" v-model="newObject.alias" id="alias">*/
/* 				<input class="form-control field--border" name="title" placeholder="Заголовок окна" type="text" v-model="newObject.title" id="title">*/
...
/* 				{{newObject.lesson_courses}}*/
/* 				<select name="field_courses_lessons[]" multiple v-model="newObject.lesson_courses">*/
/* 					<option v-for="course in courses" :value="course.id">{{course.field_header}}</option>*/
/* 				</select>*/
...
/* */
/* {% include 'footer_lk' %}*/
/* <script src="/site/theme/js/lk_lessons.js" type="module"></script>*/
